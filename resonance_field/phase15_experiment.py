...
from resonance_field.phase15_config import (
    PHASE15_MODEL_LABELS,
    PhaseXVConfig,
    build_phase15_scenarios,
)
...
def run_phase15_experiments(
    ...
    return run_phase6_experiments(
        ...
        runs=runs,
        seed_base=seed_base,
        scenarios=build_phase15_scenarios(),
        model_labels=PHASE15_MODEL_LABELS,
        experiment_tag=config.experiment_tag,
        baseline_summary_path=Path("/mnt/d/resonance_phase14_outputs/scenario_summary.csv"),
        comparison_filename="phase14_phase15_delta.csv",
        comparison_json_key="phase14_phase15_delta",
    )
