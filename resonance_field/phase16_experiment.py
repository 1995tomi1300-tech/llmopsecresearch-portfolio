...
from resonance_field.phase16_config import (
    PHASE16_MODEL_LABELS,
    PhaseXVIConfig,
    build_phase16_scenarios,
)
...
def run_phase16_experiments(
    ...
    return run_phase6_experiments(
        ...
        runs=runs,
        seed_base=seed_base,
        scenarios=scenarios or build_phase16_scenarios(),
        model_labels=model_labels or PHASE16_MODEL_LABELS,
        experiment_tag=config.experiment_tag,
        baseline_summary_path=Path("/mnt/d/resonance_phase14_outputs/scenario_summary.csv"),
        comparison_filename="phase14_phase16_delta.csv",
        comparison_json_key="phase14_phase16_delta",
    )
