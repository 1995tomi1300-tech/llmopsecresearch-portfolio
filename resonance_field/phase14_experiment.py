...
from resonance_field.phase14_config import (
    PHASE14_MODEL_LABELS,
    PhaseXIVConfig,
    build_phase14_scenarios,
)
...
def run_phase14_experiments(
    ...
    return run_phase6_experiments(
        ...
        runs=runs,
        seed_base=seed_base,
        scenarios=build_phase14_scenarios(),
        model_labels=PHASE14_MODEL_LABELS,
        experiment_tag=config.experiment_tag,
        baseline_summary_path=Path("/mnt/d/resonance_phase13_outputs/scenario_summary.csv"),
        comparison_filename="phase13_phase14_delta.csv",
        comparison_json_key="phase13_phase14_delta",
    )
